...
//        for (var key in subs.value) {
//            consoleLog(key + " " + subs.value[key]);
//        }
...
{
    consoleLog("Native.Time.setInterval");
	return _elm_lang$core$Native_Scheduler.nativeBinding(function(callback)
	{
        consoleLog("calling setInterval in JS");
