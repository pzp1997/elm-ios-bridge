			...
			_0: A2(
				...
				'label',
				{
					...
					_0: A2(
						...
						'text',
						_elm_lang$core$Json_Encode$string(model)),
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		});
...
var _user$project$Main$update = F2(
	function (msg, model) {
		var _p0 = msg;
		return {ctor: '_Tuple2', _0: 'Hello', _1: _elm_lang$core$Platform_Cmd$none};
	});
...
var _user$project$Main$init = {
	ctor: '_Tuple2',
	_0: '',
	_1: _user$project$Main$send(_user$project$Main$Start)
};
